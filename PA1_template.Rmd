...
The mean and median of total number of steps taken per day are `r mean` and 
...
The median steps of each day is `r median_no_missing`; the mean steps of each day
is `r mean_no_missing`.
